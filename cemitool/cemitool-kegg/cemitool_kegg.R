...
setwd("~/projects/sex_differences_fetal_brain/cemitool-kegg")
...
pathways <- gmtPathways("c2.cp.kegg.v7.4.symbols.gmt.txt")
...
write_files(cem, directory = '~/projects/sex_differences_fetal_brain/cemitool-kegg/Tables',force=TRUE)
...
generate_report(cem, directory = '~/projects/sex_differences_fetal_brain/cemitool-kegg/Report',force=TRUE)

save_plots(cem, 'all',
           directory = '~/projects/sex_differences_fetal_brain/cemitool-kegg/Plots',force=TRUE)
...
write.csv(a, file = "~/projects/sex_differences_fetal_brain/cemitool-kegg/hubs.txt")
