#------------------------------------------------------------------------
#title: "Cemitool after talking to Pedro (Helder)"
#author: Victor Toledo victor.toledo.btos@gmail.com"
#date: "23/09/2021"
#------------------------------------------------------------------------

################### Load all the packages and set the folder:
setwd("~/projects/sex_differences_fetal_brain/cemitool-go")
...
write_files(cem, directory = '~/projects/sex_differences_fetal_brain/cemitool-go/Tables',force=TRUE)
...
cem <- plot_gsea(cem)
go_table <- ora_data(cem)

# create report as html document
generate_report(cem, directory = '~/projects/sex_differences_fetal_brain/cemitool-go/Report',force=TRUE)

save_plots(cem, 'all',
           directory = '~/projects/sex_differences_fetal_brain/cemitool-go/Plots',force=TRUE)
...
write.csv(a, file = "~/projects/sex_differences_fetal_brain/cemitool-go/hubs.txt")
write.table(go_table, file = "~/projects/sex_differences_fetal_brain/cemitool-kegg/go_v7.5.1_enrichment_table.txt",
